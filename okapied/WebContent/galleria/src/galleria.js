    ...
    */
    ...
    _show : function() {
        ...
        var complete = function() {
            ...
            if( data.remove ) {
            	var removeLink = '<a class="remove-link" href="'+data.remove+'" >'+
            	'<img src="'+contextPath+'/images/remove_button.png" alt="Delete this Photo" title="Delete this Photo" /></a>';
            	$( next.image ).parent().append(removeLink);
            }
